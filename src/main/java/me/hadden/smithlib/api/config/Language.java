...
import me.hadden.smithlib.api.string.StringUtils;
...
public class Language {
  ...
  public static final Logger LOGGER = SmithLib.LOGGER.getModule("Language");
    ...
    for (Field field : Language.class.getDeclaredFields()) {
      if (Modifier.isStatic(field.getModifiers()) && Modifier.isPublic(field.getModifiers()) && !Modifier.isFinal(field.getModifiers())) {
        ...
        try {
          ...
          LOGGER.log(Logger.SmithLevel.WARNING, "Unexpected error on language file: ", e);
        }
      }
    }
