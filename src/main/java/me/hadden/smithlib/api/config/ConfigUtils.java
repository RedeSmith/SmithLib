...
public class ConfigUtils {
  ...
  private ConfigUtils(String path, String name) {
    ...
    if (!file.exists()) {
      ...
      InputStream in = SmithLib.getInstance().getResource(name + ".yml");
      if (in != null) {
        ...
        try {
          ...
          LOGGER.log(Logger.SmithLevel.SEVERE,
    ...
    try {
      ...
      LOGGER.log(Logger.SmithLevel.SEVERE, "Unexpected error ocurred creating config " + file.getName() + ": ",
          e);
    }
  }
  ...
  public boolean save() {
    try {
      ...
      LOGGER.log(Logger.SmithLevel.SEVERE, "Unexpected error ocurred saving file " + file.getName() + ": ", e);
      return false;
    }
  }
  ...
  public static final Logger LOGGER = SmithLib.LOGGER.getModule("ConfigUtils");
